    ...
    <div className="min-h-screen flex flex-col bg-scholarly-charcoal text-scholarly-cream bg-gradient-to-b from-scholarly-charcoal to-scholarly-navy/90">
      <main className="flex-1 flex flex-col items-center justify-center p-6">
        ...
        >
          ...
          <p className="text-xl font-light mb-8 text-scholarly-parchment">Learn better by teaching others</p>
          
          <div className="bg-scholarly-navy/80 shadow-lg rounded-xl p-8 border border-scholarly-gold/30">
            <h2 className="text-2xl font-semibold mb-6 inline-block text-scholarly-cream border-b-2 border-scholarly-gold pb-2">Start Your Session</h2>
            
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <label htmlFor="topic" className="text-sm font-medium text-scholarly-parchment">
          ...
          <p className="mt-8 text-sm text-scholarly-parchment/80">
            Explain any topic to one of our curious personas <br /> and improve your understanding through teaching.
          </p>
        </motion.div>
      </main>
