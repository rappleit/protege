...
const RecordingSection: React.FC<RecordingSectionProps> = ({
  ...
  const { topic, selectedPersona, getPersonaDetails, isRecording } =
    useSession();
    ...
    >
      <div className="mb-4">
        ...
        <p className="text-sm text-muted-foreground">
          Explain "{topic}" to {personaDetails.name} as clearly as possible. Use
          voice, text, or the whiteboard to help with your explanation.
        </p>
      </div>
